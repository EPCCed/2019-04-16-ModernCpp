...
```
git clone https://github.com/EPCCed/2019-04-16-ModernCpp.git
```
...
```
cd 2019-04-16-ModernCpp/exercises/morton-order
```
...
```bash
cd  2019-04-16-ModernCpp/exercises/morton-order/step1
```
...
```bash 
cd  2019-04-16-ModernCpp/exercises/morton-order/step2
```
